        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="px-4 py-2 bg-green-600 text-white rounded-xl text-sm font-semibold hover:bg-green-700 transition-colors flex items-center gap-2"
            >
              <span className="material-symbols-outlined text-lg">chat</span>
              <span className="hidden sm:inline">WhatsApp Test</span>
            </a>
            <button
                  ...
                  <div className="flex lg:flex-col items-center gap-2">
                    ...
                    <div className="flex gap-2 w-full mt-2 lg:mt-0 lg:w-auto">
                      <a
                        ...
                        className="p-2 rounded-xl bg-green-50 text-green-600 hover:bg-green-100 transition-colors flex-1 flex justify-center lg:flex-none"
                        title="Call customer"
                      >
                      ...
                      <button
                        ...
                        className="p-2 rounded-xl bg-[#25D366]/10 text-[#25D366] hover:bg-[#25D366]/20 transition-colors flex-1 flex justify-center lg:flex-none"
                        title="WhatsApp"
                      >
                      ...
                      <button
                        ...
                        className="p-2 rounded-xl bg-red-50 text-red-600 hover:bg-red-100 transition-colors flex-1 flex justify-center lg:flex-none"
